...
I have vivid memories of playing on the ColecoVision, Atari 2600, NES, and SNES, and later discovering computer adventures like King’s Quest and Space Quest. My father tried to introduce me to programming back then, but I was more interested in playing than coding—and at seven or eight years old, I was probably a bit too young to fully appreciate it.
...
A teacher recognized my potential and gave me more ambitious assignments—often game-related—which lit a spark. I became a fixture in the computer lab: writing code, testing games, helping classmates, and trading tips with other motivated students. I was a total nerd, and I loved it.
...
Yes, I trained in C/C++, SQL, and other tools (some now obsolete), but the most valuable takeaways were:

- Humility: even when you know a lot, there’s always more to learn.
- Lifelong learning: growth is a journey that requires constant curiosity, practice and effort.
...
For the first six years of my career, I worked as a back-end Java developer, using technologies like J2EE, Spring, Hibernate, ActiveMQ, Maven, Ant, Gradle, Log4j, JBoss, and Tomcat. I learned a great deal, but eventually my growth plateaued. When Apple released the iPhone and opened up the iOS SDK, I embraced the opportunity to explore something new.

I had already switched to a Mac at home, so installing Xcode and learning Objective-C was an accessible next step—though it required a major mindset shift. After years of Java’s garbage collection, returning to manual memory management felt like a cold shower.
