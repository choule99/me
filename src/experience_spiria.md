...
- CAE PreStudy Pilot Training Application — Architecture and development across back end, front end, and iOS components.
- Acosta SLTouch — Hybrid mobile application frameworks and feature delivery.
- Skillable App — Progressive Web App architecture and implementation support.
- Payfare (DiDi / Lyft) — iOS and Android contributions for fintech-related functionality.
- BookJane — Mobile development for workforce management features.
