...
As a mobile development studio, I contributed to numerous client projects across diverse industries:

- **Metro & Moi** — Food Retail
- **Super C** — Food Retail
- **Food Basics** — Food Retail
- **AbbVie Maviret** — Pharmaceutical
- **WKND / BLVD Radio** — Live Entertainment
- **Le Devoir** — News & Media
- **Biodome de Montréal** — Tourism
- **Christies Luxury Art** — Auction
- **BeautéStar** — Retail
- **MPN Genie** — Healthcare
- **Amigo Express** — Sustainable Mobility
- **TaxiCoop** — Mobility
- **Technic** — Academic
- **iQuad** — Tourism
