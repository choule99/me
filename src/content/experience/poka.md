...
**CI/CD Architecture** — Automated App Store deployments end-to-end; increased release cadence from 1/week to 4/day and improved CI build speeds by 50% through MacStadium migration.

### Responsibilities

- Conducted R&D on iOS and visionOS capabilities, architectures, and patterns
- Bridged gaps between engineering, Product Management, and UX Design; established collaboration workflows aligning technical solutions with business goals
